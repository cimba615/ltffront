...
@Component({
  selector: 'ltf-special-payment-lbp',
  templateUrl: './special-payment-lbp.component.html',
  styleUrls: ['./special-payment-lbp.component.sass']
})
export class SpecialPaymentLBPComponent implements OnInit {
  ...
  processPaymentLBP() {
    if (this.paymentForm.valid) {
      ...
      this.spService.postSpecialPaymentLBP({
